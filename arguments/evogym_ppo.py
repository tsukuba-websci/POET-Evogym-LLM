...
def get_args():
    parser = argparse.ArgumentParser(description="Evogym PPO experiment")

    parser.add_argument("name", type=str, help="name of POET experiment")
    parser.add_argument("key", type=int, help="niche key")
    ...
    parser.add_argument(
        "-e", "--epochs", default=4, type=int, help="number of ppo epochs (default: 4)"
    )
    parser.add_argument(
        "-i",
        "--train-iters",
